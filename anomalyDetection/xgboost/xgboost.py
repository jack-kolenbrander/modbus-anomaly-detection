...
# Due to utilization of SMOTE, impute dataset missing values
# Imputation options include mean, median, mode
imputer = SimpleImputer(strategy='median')
X_train = imputer.fit_transform(X_train)
X_val = imputer.transform(X_val)

# For xgboost, need to encode dataset classifications to numeric values 
le = LabelEncoder()
...
plt.tight_layout()
plt.savefig('confusion_matrix_sample_weights.png', dpi=300, bbox_inches='tight')
plt.show()
